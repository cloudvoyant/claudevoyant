---
description: 'Critique a skill for effectiveness: does it achieve its objective, are the instructions high-quality, and will its output templates produce reader-friendly artifacts? Use this whenever someone asks to "critique a skill", "review skill quality", "check if a skill is well-written", "improve skill instructions", "audit this skill", "is this skill effective", or "is this skill good". Distinct from skill:review (which checks spec compliance) — skill:critique evaluates whether the skill will actually work well.'
name: skill:critique
license: MIT
