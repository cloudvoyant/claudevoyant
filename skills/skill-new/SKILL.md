---
description: 'Create a new Claude Code / Agent Skills compatible skill. Guides through template, frontmatter, argument parsing, step design, agent index, and destination. Triggers on: "skill new", "create a skill", "make a skill for", "add a slash command", "new skill", "build a skill".'
name: skill:new
license: MIT
...
argument-hint: '[skill-name] [--research <path>]'
