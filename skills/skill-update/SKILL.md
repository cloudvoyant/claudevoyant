---
description: 'Update an in-progress skill plan or improve an existing committed skill. For existing skills, asks which dimensions to improve: prompt quality, performance, agent additions, or skill dependencies. Triggers on: "skill update", "update skill", "improve skill", "refine skill", "edit skill".'
name: skill:update
license: MIT
compatibility: 'Designed for Claude Code. On OpenCode and VS Code Copilot, AskUserQuestion falls back to numbered list.'
argument-hint: '[skill-name-or-plan]'
